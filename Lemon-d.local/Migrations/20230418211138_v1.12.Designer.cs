...
namespace Lemon_d.local.Migrations
{
    ...
    [Migration("20230418211138_v1.12")]
    partial class v112
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lemon_d.local.Database.DbModels.PlayerAmount", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Lemon_d.local.Database.DbModels.Project", b =>
                {
                    ...
                    b.Property<Guid>("PlayerAmountID")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Lemon_d.local.Database.DbModels.Project", b =>
                {
                    ...
                    b.HasOne("Lemon_d.local.Database.DbModels.PlayerAmount", "PlayerAmount")
                        .WithMany()
                        .HasForeignKey("PlayerAmountID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
